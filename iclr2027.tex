...
\begin{abstract}
  ...
  However, methods such as GRPO rely on \textit{prompt-level (local)} advantage normalization, whose finite-sample distortion we characterize and whose training stability and held-out generalization we examine.
  ...
  By normalizing advantages across the entire global batch rather than small, prompt-specific groups, our method uses a shared scale whose sample moments converge under independent sampling; this does not imply unbiasedness of the full policy gradient.
...
Generative AI tools assisted with template migration, formatting, compilation diagnostics, and mathematical exposition and proof revision. They were not used to generate experimental data, fabricate results, or conduct new experiments. The authors reviewed all AI-assisted work and take responsibility for the final content of this paper, including its text, claims, and artifacts.
